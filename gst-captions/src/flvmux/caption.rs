...
//! Caption state and AMF transition scheduling for `captionsflvmux`.

use std::fmt;

use crate::flvmux::amf::{MAXIMUM_TEXT_BYTES, MessageName, script_data_body};
use crate::flvmux::flv::{MAXIMUM_TIMESTAMP_MS, script_data_tag};
...
impl CaptionTimeline {
  ...
  /// `captionsflvmux` before this method and never enter the UTF-8 decoder.
