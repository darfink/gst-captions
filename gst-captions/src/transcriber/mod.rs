...
#[repr(u32)]
#[enum_type(name = "GstCaptionsMode")]
#[non_exhaustive]
pub enum Mode {
...
#[derive(Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Clone, Copy, Default, glib::Enum)]
#[repr(u32)]
#[enum_type(name = "GstCaptionsOverrun")]
#[non_exhaustive]
pub enum Overrun {
...
mirror_enum! {
    ...
    #[enum_type(name = "GstCaptionsBackend")]
...
mirror_enum! {
    ...
    #[enum_type(name = "GstCaptionsTask")]
...
mirror_enum! {
    ...
    #[enum_type(name = "GstCaptionsTimestamps")]
...
mirror_enum! {
    ...
    #[enum_type(name = "GstCaptionsKvType")]
...
mirror_enum! {
    ...
    #[enum_type(name = "GstCaptionsCommitPolicy")]
...
glib::wrapper! {
    pub struct CaptionsTranscriber(ObjectSubclass<imp::CaptionsTranscriber>) @extends gst::Element, gst::Object;
}
...
pub fn register(plugin: &gst::Plugin) -> Result<(), glib::BoolError> {
  ...
  gst::Element::register(
    ...
    "captionstranscriber",
    gst::Rank::NONE,
    CaptionsTranscriber::static_type(),
  )
}
